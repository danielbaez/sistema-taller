...
class CategoriesController extends Controller
{
    ...
    public $titleForm = 'Categoría';
    public $titleMessageLog = 'la categoría';
    ...
    public function update(CategoryRequest $request, Category $category)
    {
        try {
            ...
            logsStore("update", "$this->titleMessageLog $category->name - id: $category->id", 1);
            ...
            logsStore("update", "$this->titleMessageLog - id: $category->id", 0, $e);
    ...
    {
        return destroyGeneric($request, $category, $this->titleMessageLog.' '.$category->name);
    }
}

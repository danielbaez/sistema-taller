...
class ModelsController extends Controller
{
    ...
    public $titleForm = 'Modelo';
    public $titleMessageLog = 'el modelo';
    ...
    public function update(ModelRequest $request, Model $model)
    {
        try {
            ...
            logsStore("update", "$this->titleMessageLog $model->name - id: $model->id", 1);
            ...
            logsStore("update", "$this->titleMessageLog - id: $model->id", 0, $e);
    ...
    {
        return destroyGeneric($request, $model, $this->titleMessageLog.' '.$model->name);
    }
}
